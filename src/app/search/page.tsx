    ...
    <PageLayout activePath='/search'>
      <div className='px-4 sm:px-10 py-4 sm:py-8 overflow-visible mb-10'>
        ...
        <div className='mb-8 max-w-3xl mx-auto'>
          <div className='bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl border border-gray-200/40 dark:border-gray-700/40 rounded-2xl shadow-lg px-4 py-3'>
            <form onSubmit={handleSearch} className=''>
              ...
              <input
                ...
                autoComplete="off"
                className='w-full h-12 rounded-full bg-white/20 dark:bg-gray-900/30 backdrop-blur-md py-3 pl-10 pr-12 text-sm text-gray-700 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-400 border border-gray-200/50 shadow-sm dark:text-gray-300 dark:placeholder-gray-400 dark:border-gray-700'
              />
        ...
        <div className='max-w-[95%] mx-auto mt-12 overflow-visible'>
          {showResults ? (
            <section className='mb-12 bg-white/20 dark:bg-gray-900/30 backdrop-blur-xl border border-gray-200/40 dark:border-gray-700/40 rounded-2xl shadow-lg p-4 sm:p-6'>
              {/* 标题 */}
              <div className='mb-4'>
                ...
                {searchHistory.map((item) => (
                  <div key={item} className='relative group'>
                    <button
                      ...
                      className='px-4 py-2 bg-white/20 dark:bg-gray-900/30 backdrop-blur-md hover:bg-white/30 dark:hover:bg-gray-900/40 border border-gray-200/40 dark:border-gray-700/40 rounded-full text-sm text-gray-700 transition-colors duration-200 dark:text-gray-300'
                    >
                      {item}
                    </button>
                    {/* 删除按钮 */}
