      ...
      <>
        ...
        >
          ...
          >
            ...
            >
              <span
                className='inline-flex items-center max-w-full text-sm font-semibold truncate text-gray-900 dark:text-gray-100 transition-colors duration-300 ease-in-out group-hover:text-green-600 dark:group-hover:text-green-400 peer px-3 py-1 rounded-full bg-white/40 dark:bg-gray-900/40 backdrop-blur-2xl border border-white/40 dark:border-gray-700/50 shadow-lg'
                style={
                  {
                    WebkitUserSelect: 'none',
                    userSelect: 'none',
